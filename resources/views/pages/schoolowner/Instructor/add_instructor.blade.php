...
@section('content')
    ...
    <div class="p-6 max-w-7xl ml-64 mt-10">
        ...
        <nav class="text-gray-500 text-sm mb-6 flex gap-2 select-none">
            ...
            <span>/</span>
            <span class="text-gray-700 font-semibold">Add Instructor</span>
        </nav>

        <form action="{{ route('schoolowner.instructors.add_instructor') }}" method="POST" class="space-y-6"
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="tel" id="phone" name="phone" value="{{ old('phone') }}" required
                        pattern="^03\d{9}$" placeholder="03078976541"
                        class="w-full border border-gray-300 rounded-md px-3 py-2 focus:outline-none focus:ring-2 focus:ring-indigo-400" />
                ...
                <div>
                    ...
                    <input type="text" id="id_card_number" name="id_card_number" value="{{ old('id_card_number') }}"
                        required placeholder="42301-7865432-0" pattern="^\d{5}-\d{7}-\d{1}$" maxlength="15"
                        class="w-full border border-gray-300 rounded-md px-3 py-2 focus:outline-none focus:ring-2 focus:ring-indigo-400" />
                ...
                <div>
                    ...
                    <input type="number" id="salary" name="salary" value="{{ old('salary') }}" required min="0"
                        max="99999999" inputmode="numeric" onwheel="this.blur()" placeholder="50000"
                        class="w-full border border-gray-300 rounded-md px-3 py-2 focus:outline-none focus:ring-2 focus:ring-indigo-400" />
                    @error('salary')
                        <p class="text-red-600 text-sm mt-1">{{ $message }}</p>
                    @enderror
                ...
                <div>
                    ...
                    <input type="text" id="license_city" name="license_city" value="{{ old('license_city') }}" required
                ...
                <div>
                    ...
                    <input type="text" id="license_number" name="license_number" value="{{ old('license_number') }}"
                        required pattern="^[A-Z0-9\-]{5,15}$" maxlength="15" placeholder="IDP-786541"
                        class="w-full border border-gray-300 rounded-md px-3 py-2 focus:outline-none focus:ring-2 focus:ring-indigo-400" />
                ...
                <div>
                    ...
                    <input type="number" id="experience" name="experience" value="{{ old('experience') }}" required
                        min="1" max="99" inputmode="numeric" onwheel="this.blur()" placeholder="5"
                        class="w-full border border-gray-300 rounded-md px-3 py-2 focus:outline-none focus:ring-2 focus:ring-indigo-400" />
                    @error('experience')
                        <p class="text-red-600 text-sm mt-1">{{ $message }}</p>
                    @enderror
                ...
                <div>
                    ...
                    <select name="gender" id="gender" required
                        class="w-full border border-gray-300 rounded-md px-3 py-2 focus:outline-none focus:ring-2 focus:ring-indigo-400">
                        <option value="" disabled {{ old('gender') ? '' : 'selected' }}>Please Select Gender
                        </option>
