...
<div class="container mx-auto p-2">
    <!-- Cards Row: flexbox instead of grid -->
    <div class="flex flex-wrap md:flex-nowrap gap-6 mb-8">
        <div class="flex-1 min-w-[200px] bg-white dark:bg-[#171717] rounded-lg shadow p-4 flex items-center gap-4">
    ...
    <!-- Charts Row: flexbox instead of grid -->
    <div class="flex flex-wrap md:flex-nowrap gap-6 mb-8">
        <div class="flex-1 min-w-[300px] bg-white dark:bg-[#171717] rounded-lg shadow p-4">
